            ...
            <div className="container mx-auto px-4">
                <div className="text-left mb-16 max-w-4xl">
                    <ScrollReveal as="h2" className="text-4xl md:text-6xl font-bold text-foreground mb-4 leading-[1.1] tracking-tight mx-0">
                        Vier Wege zur Rechtssicherheit. <br className="hidden md:block" /> Wählen Sie Ihren.
                    </ScrollReveal>
                </div>

                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 auto-rows-fr">
                    {/* Card 1: AI-Readiness & Potenzialanalyse (NEW) */}
                    <div className="bg-card p-8 rounded-custom border border-border-subtle flex flex-col h-full transition-theme hover:border-primary">
                        <div className="mb-6 flex-grow">
                            <h3 className="text-2xl font-bold text-foreground mb-2">AI-Readiness & Potenzialanalyse</h3>
                            <p className="text-sm text-gray-400 italic mb-6">Für Praxen & MVZs am Anfang der KI-Reise</p>

                            <p className="text-gray-600 mb-6 leading-relaxed">
                                Sie hören viel über KI, wissen aber nicht, wo Sie anfangen sollen? Wir finden heraus, wo KI Ihren Praxisalltag wirklich entlastet – und was nur Spielerei ist. Ich analysiere Ihre Abläufe auf:
                            </p>

                            <ul className="space-y-3 mb-8">
                                <li className="flex items-start gap-3 text-sm text-gray-600">
                                    <Check className="w-5 h-5 text-primary shrink-0" />
                                    <span><strong>Automatisierungspotenzial:</strong> Wo sparen Sie durch KI konkret Zeit? (Arztbriefe, Telefon, Abrechnung)</span>
                                </li>
                                <li className="flex items-start gap-3 text-sm text-gray-600">
                                    <Check className="w-5 h-5 text-primary shrink-0" />
                                    <span><strong>Machbarkeits-Check:</strong> Welche Tools passen zu Ihrer bestehenden IT-Infrastruktur?</span>
                                </li>
                                <li className="flex items-start gap-3 text-sm text-gray-600">
                                    <Check className="w-5 h-5 text-primary shrink-0" />
                                    <span><strong>Erste Sicherheits-Einschätzung:</strong> Was ist datenschutzrechtlich überhaupt erlaubt?</span>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="mt-auto border-t border-border-subtle pt-6">
                            <div className="mb-6 space-y-2">
                                <div className="flex justify-between items-baseline text-sm">
                                    ...
                                    <span className="font-bold text-foreground text-right w-2/3">Konkrete Roadmap & Use-Case-Liste</span>
                                </div>
                                <div className="flex justify-between items-baseline text-sm">
                                    <span className="text-gray-500">Dauer:</span>
                                    <span className="font-bold text-foreground">1 Workshop-Tag (inkl. Auswertung)</span>
                                </div>
                                <div className="flex justify-between items-baseline text-sm">
                                    <span className="text-gray-500">Preis:</span>
                                    <span className="font-bold text-foreground">Ab 1.900 € (Festpreis)</span>
                                </div>
                            </div>
                    ...
                    {/* Card 3: Sovereign AI Implementation */}
                    <div className="bg-card p-8 rounded-custom border border-border-subtle flex flex-col h-full transition-theme hover:border-primary">
                        <div className="mb-6 flex-grow">
                    ...
                    {/* Card 4: Technical Compliance Engineering */}
                    <div className="bg-card p-8 rounded-custom border border-border-subtle flex flex-col h-full transition-theme hover:border-primary">
                        <div className="mb-6 flex-grow">
