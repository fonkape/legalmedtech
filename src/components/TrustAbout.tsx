    ...
    return (
        <section id="about" className="py-[var(--section-padding)] transition-theme theme-legacy:bg-sand/20 theme-precision:section-onyx">
            <div className="container mx-auto px-4">
                <div className="flex justify-center mb-16 theme-precision:justify-start">
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-white rounded-custom shadow-sm border border-border-subtle transition-theme theme-precision:bg-[#121212] theme-precision:border-primary theme-precision:text-primary">
                        <User className="w-4 h-4 text-primary" />
                        <span className="text-sm font-bold tracking-wide uppercase">Über mich</span>
                    </div>
                </div>
                    ...
                    <div className="order-2 lg:order-1">
                        ...
                        <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div className="flex items-start gap-4 p-4 border border-border-subtle rounded-custom transition-theme theme-precision:bg-white/5">
                                ...
                                <div>
                                    <span className="text-foreground font-bold block">Jurist (WWU Münster):</span>
                                    <span className="text-sm opacity-70">Diplom-Jurist mit Fokus auf Wirtschaftsrecht.</span>
                                </div>
                            </div>
                            <div className="flex items-start gap-4 p-4 border border-border-subtle rounded-custom transition-theme theme-precision:bg-white/5">
                                <CheckCircle2 className="w-5 h-5 text-primary mt-1 flex-shrink-0" />
                                <div>
                                    ...
                                    <span className="text-sm opacity-70">Tiefenexpertise in Compliance & Vertragsgestaltung.</span>
                                </div>
                            </div>
                            <div className="flex items-start gap-4 p-4 border border-border-subtle rounded-custom transition-theme theme-precision:bg-white/5">
                                <CheckCircle2 className="w-5 h-5 text-primary mt-1 flex-shrink-0" />
                                <div>
                                    <span className="text-foreground font-bold block">AI Engineer (in training):</span>
                                    <span className="text-sm opacity-70">Fokus auf LLM-Architekturen und technische Kapselung.</span>
                                </div>
                            </div>
                            <div className="flex items-start gap-4 p-4 border border-border-subtle rounded-custom transition-theme theme-precision:bg-white/5">
                                <CheckCircle2 className="w-5 h-5 text-primary mt-1 flex-shrink-0" />
                                <div>
                                    <span className="text-foreground font-bold block">Spezialisierung Healthcare:</span>
                                    <span className="text-sm opacity-70">Experte für DSGVO Art. 9, MDR und den EU AI Act.</span>
                                </div>
                            </div>
                        </div>
                    </div>
